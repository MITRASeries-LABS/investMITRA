"""
investMITRA — Prefect Flow: NSE Delivery % Daily Ingestion
Flow name: ingest_market_data_nse_delivery_daily
Schedule: 8:15 PM IST (14:45 UTC) Mon-Fri
  15 min after NSE Bhavcopy so both are available for join
"""
